...
<html dir="ltr" mozdisallowselectionprint>
  <head>
    ...
    <link rel="stylesheet" href="/resources/library/pdfJS/web/viewer.css">

<!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="/resources/library/pdfJS/web/locale/locale.properties">
    <script src="/resources/library/pdfJS/build/pdf.js"></script>

    <script src="/resources/library/pdfJS/web/viewer.js"></script>
    
    <style>
      #toolbarViewerRight, #viewFind, #viewOutline, #viewAttachments, #viewLayers {
        display: none;
      }
    </style>
...
<!--    <div id="secondaryToolbar" class="secondaryToolbar hidden doorHangerRight">
            ...
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <div class="splitToolbarButton hiddenSmallView">
                  <button class="toolbarButton" disabled="disabled" title="Previous Page" id="previous" tabindex="13" data-l10n-id="previous">
                    <span data-l10n-id="previous_label">Previous</span>
                  </button>
                  <div class="splitToolbarButtonSeparator"></div>
                  <button class="toolbarButton" disabled="disabled" title="Next Page" id="next" tabindex="14" data-l10n-id="next">
    ...
    <script>
      // document.querySelector("#toolbarViewerRight").remove();
    </script>
  </body>
</html>
