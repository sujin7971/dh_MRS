	...
	<div class="bodyDiv">
        <div class="scheduleWriteDiv"><!--------  전자회의 입력사항은 row 에 class="electContent" 를 추가하세요-------->
			<div class="formLDiv">	
				...
				<input name="skdKey" type="hidden" value="${skdKey}"/>
					...
					<div class="answer align-items-center">
						<div class="flex-row">
							<div class="selectDiv border-0">
			                    ...
			                    <select id="officeSelect" name="officeCode">
				...
				<div class="row">
					<div class="item">
						...
						<span class="input-limit" data-length="skdHost">0/10</span>
					</div>
					<div class="answer input-delete">
						<input type="text" class="input-lg width100p" name="skdHost" maxlength="10" placeholder="회의 주관자를 입력해 주세요"  oninput="Util.acceptWithinLength(this);Util.displayInputLength(this)"> 
				...
				<div class="row electContent">
					<div class="item">
						...
						<button type="button" class="btn btn-sm btn-blue-border" data-btn="hostBtn">진행자 선택</button>
					</div>
					<div class="answer">
				...
				<div class="row except electContent">
					...
					<div class="answer">
						<div class="checkboxDiv">
							<label for="switchMessenger"><input type="checkbox" name="messengerYN" value="Y" id="switchMessenger"><span><span class="dot"></span>관련자 메신저알림</span></label>
							<label for="switchSms"><input type="checkbox" name="smsYN" value="Y" id="switchSms"><span><span class="dot"></span>관련자 SMS 알림</span></label>
						</div>						
					</div>
				</div> 
...
const isInsert = (skdKey && skdKey.length != 0)?false:true;
</script>
<script type="module" src="/resources/front-end-assets/js/ewp/page/meeting/assign/assign_write.js"></script>
</body>
</html>