...
<div class="wrapper">
    <div class="titDiv timetable">
        ...
        <div class="viewOptionBtn">
            <div class="radioDiv2">
                <label for="vOptionC">
                    <input type="radio" id="vOptionC" name="vOption" onclick="location.href='/ewp/meeting/assign/status/list?holdingDate=${holdingDate}'">
                    <span>목록보기</span>
                </label>
                <label for="vOptionP" >
                    <input type="radio" id="vOptionP" name="vOption" onclick="location.href='/ewp/meeting/assign/status/timetable?holdingDate=${holdingDate}'" disabled checked>
                    <span>타임테이블</span>
                </label>
            </div>
        </div>
        ...
        <div class="row">
			<div class="answer date">
				<div data-input="date" id="dateDiv">
			 		<input type="text" id="dateInput" class="width100p input-md" readonly></div>
			</div>
		</div>
    </div>
...
<script type="module" src="${urls.getForLookupPath('/resources/front-end-assets/js/ewp/page/meeting/assign/dist/assign_status_timetable.bundle.js')}"></script>
</body>
</html>