	...
	<div class="overflow-auto margin-bottom-10">
		<div class="bodyDiv">
	        <div class="reportFormDiv" id="reportBox">
	            ...
	            <div class="row">
	                <div class="item">
	                    <div class="tit"><span>참석자 검토 확인</span><span class="confirmCount" id="reportConfirmCountInput">6/8</span></div>
	                </div>
	                <div class="answer">
		...
		<div class="pageBtnDiv report"> <!--회의록작성자 & 회의 종료전-->
			...
			<c:if test='${authorityCollection.hasAuthority("FUNC_OPEN") }'>
			<button class="btn btn-lg btn-blue-border" id="openOpnBtn">임시저장 & 검토요청</button>
			</c:if>
		...
		<!-- 참석자 검토의견 section 시작 -->
	    <section class="attenderOpinionDiv">
	        <!-- 검토의견 입력란 row 시작-->
	        <!-- 회의록작성이 최종 완료 저장되면 입력란 row에 add class "display-none" -->
	        <c:choose>
		        <c:when test='${authorityCollection.hasAuthority("FUNC_OPINION") }'>
			        <div class="row">
			            <div class="item titleDiv">회의록 내용 동의</div>
			            <div class="answer">
			                <div class="checkDiv">
			                    <label for="agreeYN" class="width100p">
			                        <input type="checkbox" id="agreeYN">
			                        <span>회의록 내용에 동의합니다.</span>
			                    </label>
			                </div>
			            </div>
			        </div>
			        <div class="confirmDiv row">
			            <div class="item titleDiv">회의록 검토 의견</div>
			            <div class="answer">
			                <input type="text" class="input-lg" maxlength="200" placeholder="검토의견을 입력해주세요" id="opinionInput">               
			                <button class="btn btn-lg btn-blue" id="opinionWriteBtn">저 장</button>
			            </div>
			        </div>
			        <div class="row line">
			            <div class="btnRefresh" id="reloadBtn">참석자 검토의견 새로고침</div>
			        </div>
		        </c:when>
		        <c:otherwise>
		        	<div class="titleDiv">회의록 검토 의견</div>
		        </c:otherwise>
	        </c:choose>
	        <!-- 검토의견 입력란 row 끝 -->
			<div id="opinionBox">
...
<script type="module" src="/resources/front-end-assets/js/ewp/page/meeting/report/report_write.js"></script>
</body>
</html>