...
<head>
	...
	<link rel="stylesheet" href="/resources/meetingtime/ewp/css/meetingroom.css">
...
<jsp:include page="/WEB-INF/partials/ewp/modal/meeting/space/roomModal.jsp"></jsp:include>
<jsp:include page="/WEB-INF/partials/ewp/modal/meeting/space/fileModal.jsp"></jsp:include>
<jsp:include page="/WEB-INF/partials/ewp/modal/meeting/space/selectAssistantModal.jsp"></jsp:include>
<jsp:include page="/WEB-INF/partials/ewp/modal/meeting/space/finishModal.jsp"></jsp:include>
</body>
<script>
...
<script type="module" src="${urls.getForLookupPath('/resources/front-end-assets/js/ewp/page/meeting/space/dist/core-module.bundle.js')}"></script>
</html>