...
<head>
    ...
    <script type="text/javascript" src="/resources/meetingtime/ewp/js/chart.js"></script>
    <script type="text/javascript" src="/resources/meetingtime/ewp/js/chartjs-plugin-datalabels.js"></script>
    	...
    	<div class="row">
    		<div class="answer date">
				<div data-input="startDate" id="startDateDiv">
					<input type="text" id="startDateInput" class="width100p input-md cursor-pointer bg-white" readonly>
				</div>
				<span class="period">~</span>
		   		<div data-input="endDate" id="endDateDiv">
		    		<input type="text" id="endDateInput" class="width100p input-md cursor-pointer bg-white" readonly>
		    	</div>
			</div>
    	</div>
...
<script type="module" src="/resources/front-end-assets/js/ewp/page/meeting/meeting_stat.js"></script>
</body>
</html>