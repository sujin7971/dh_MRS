...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" href="/resources/meetingtime/lime/css/jquery.mobile-1.4.5.css">
	<link rel="stylesheet" href="/resources/meetingtime/lime/css/fa.css">
	<link rel="stylesheet" href="/resources/meetingtime/lime/css/meetingDisplay.css">
	<script type="text/javascript" src="/resources/meetingtime/lime/js/jquery-2.2.4.min.js"></script>
	<script type="text/javascript" src="/resources/meetingtime/lime/js/jquery.mobile-1.4.5.min.js"></script>
...
import {AssignCall as $AS} from '/resources/front-end-assets/js/lime/ajax/ajax_index.js';
window.Util = Util;
window.$AS = $AS;
</script>
<script>
