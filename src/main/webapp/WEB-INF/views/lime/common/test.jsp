...
<div id="boardModal" class="modal addNoticeModal">
    <div class="modalWrap">
                    ...
                    <div class="row">
						...
						<div class="answer d-flex flex-column">
							...
							<div class="infoMentDiv m-0">
								<p class="py-0">첨부파일 지원 : 한글(HWP, HWPX), PDF, MS OFFICE 문서(PPT, PPTX, DOC, DOCX, XLS, XLSX), 이미지(JPG, JPEG, GIF, PNG, BMP) </p>
							</div>
						</div>
					</div>
                </div>
...
<script type="module"
	src="/resources/front-end-assets/js/ewp/page/common/test.js"></script>
</html>