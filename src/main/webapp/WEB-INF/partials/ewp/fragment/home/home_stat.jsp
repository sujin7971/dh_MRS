...
<!-- 나의 전자회의 성과 안내 모달 -->
<jsp:include page="/WEB-INF/partials/ewp/modal/meeting/guideForStatModal.jsp"></jsp:include>
<script type="module" src="${urls.getForLookupPath('/resources/front-end-assets/js/ewp/partials/fragment/home/dist/home_stat.bundle.js')}"></script>
