...
<div class="gnbWrapPC">
    <div class="gnbInfo">
        ...
        <div class="ci pt-3" onclick="location.href='${logoUrl }'">
            <div class="ciSvg ">
        ...
        <div class="shy-menu-panel">
            <ul>
            	<c:if test='${userRole.hasRole("ROLE_GENERAL")}'>
	                <li class="mainMenu mn1" title="오늘의 스케줄" onclick="location.href='/lime/dashboard'">
	                    <i class="fas fa-home-lg-alt"></i>
	                    <span>오늘의 스케줄</span>
	                </li>
	                <li class="mainMenu mn12" title="배정현황" onclick="location.href='/lime/meeting/assign/status/timetable'">
	                    <i class="fas fa-th-large"><i class="fas fa-clock"></i></i>
	                    <span>배정현황</span>
	                </li>
	                <li class="mainMenu mn15" title="사용신청목록" onclick="location.href='/lime/meeting/assign/manage/user'">
	                ...
	                <li class="mainMenu mn3" title="통계" onclick="location.href='/lime/meeting/stat'">
	                    <i class="fas fa-chart-pie"></i>
	                    <span>통계</span>
	                </li>
                </c:if>
                	<c:if test='${userRole.hasPosition("MNG_APPROVAL")}'>
		                <li class="mainMenu mn6" title="사용신청 관리" onclick="location.href='/lime/manager/approval/manage/meeting'">
		                    <i class="fas fa-tasks"></i>
		                    <span>사용신청 관리</span>
		                </li>
		            </c:if>
	                <c:if test='${userRole.hasRole("ROLE_SYSTEM_ADMIN")}'>
	                	<li class="mainMenu mn8" title="조직관리" onclick="location.href='/lime/admin/system/manage/organization'">
		            		<i class="fas fa-sitemap"></i>
		            		<span>조직관리</span>
		            	</li>
	                	<li class="mainMenu mn5" title="권한관리" onclick="location.href='/lime/admin/system/manage/authority'">
		            		<i class="fas fa-users-cog"></i>
		            		<span>권한관리</span>
		            	</li>
		                <li class="mainMenu mn4" title="관리자" onclick="location.href='/lime/admin/system/manage/room'">
		               		<i class="fas fa-lock"></i>
		                    <span>관리자</span>
		            	</li>
	                </c:if>
	            <c:if test='${userRole.hasRole("ROLE_DEV")}'>
                	<li class="mainMenu mn7" title="인증 정보 변경" onclick="location.href='/lime/dev/switch-authentication'">
	                    <i class="fas fa-people-arrows"></i>
	                    <span>인증 정보 변경</span>
	                </li>
	                <li class="mainMenu mn5" title="테스트" onclick="location.href='/lime/home/test'">
    ...
    <div class="modalWrap">
        <div class="modal_content">
            ...
            <div class="modalBody flex-direction-column align-items-center">
                ...
                <div class="width100p">
                    <p id="deptName" class="uDivision"><c:out value="${loginEmp.deptName }"/></p>
                    <p data-input="userName" id="userName" class="userName uNameGrade"><c:out value="${loginEmp.userName }"/></p>
                </div>
                <div class="f2">
                	<p><span>사번</span><span class="uComNum"><c:out value="${loginEmp.userId }"/></span></p>
...
<script type="module" src="/resources/front-end-assets/js/lime/page/common/navigation.js"></script>
