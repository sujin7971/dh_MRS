...
const statDataManager = {
	...
	async getPaperlessStatForCompany(){
		if(!this.paperlessStatForCompany){
			this.paperlessStatForCompany = await $MEETING.Get.paperlessStatForCompany(this.getPeriod());
		}
	...
	async getMeetingCountAndAverageDurationStatForCompany(){
		if(!this.meetingCountAndAverageDurationStatForCompany){
			this.meetingCountAndAverageDurationStatForCompany = await $MEETING.Get.meetingCountAndAverageDurationStatForCompany(this.getPeriod());
		}
	...
	async getTop5DepartmentWithMeetingForCompany(){
		if(!this.top5DepartmentWithMeetingForCompany){
			this.top5DepartmentWithMeetingForCompany = await $MEETING.Get.top5DepartmentWithMeetingForCompany(this.getPeriod());
		}
	...
	async getMeetingMonthlyTrendForCompany(){
		if(!this.meetingMonthlyTrendForCompany){
			this.meetingMonthlyTrendForCompany = await $MEETING.Get.meetingMonthlyTrendForCompany(this.getPeriod());
		}
		return this.meetingMonthlyTrendForCompany;
	},
	async getPaperlessStatForPersonal(){
		if(!this.paperlessStatForPersonal){
			this.paperlessStatForPersonal = await $MEETING.Get.paperlessStatForPersonal(this.getPeriod());
		}
	...
	async getMeetingCountAndTotalDurationStatForHosting(){
		if(!this.meetingCountAndTotalDurationStatForHosting){
			this.meetingCountAndTotalDurationStatForHosting = await $MEETING.Get.meetingCountAndTotalDurationStatForHosting(this.getPeriod());
		}
	...
	async getMeetingCountAndTotalDurationStatForAttendance(){
		if(!this.meetingCountAndTotalDurationStatForAttendance){
			this.meetingCountAndTotalDurationStatForAttendance = await $MEETING.Get.meetingCountAndTotalDurationStatForAttendance(this.getPeriod());
		}
	...
	async getTop5DepartmentWithMeetingForOffice(){
		if(!this.top5DepartmentWithMeetingForOffice){
			this.top5DepartmentWithMeetingForOffice = await $MEETING.Get.top5DepartmentWithMeetingForOffice(this.getPeriod());
		}
	...
	async getMeetingMonthlyTrendForPersonal(){
		if(!this.meetingMonthlyTrendForPersonal){
			this.meetingMonthlyTrendForPersonal = await $MEETING.Get.meetingMonthlyTrendForPersonal(this.getPeriod());
		}
