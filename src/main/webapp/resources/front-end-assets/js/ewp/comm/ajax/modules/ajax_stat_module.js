...
const getPaperlessStatForCompany = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/paperless/company`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getMeetingCountAndAverageDurationStatForCompany = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/count-and-avgduration/company`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getTop5DepartmentWithMeetingForCompany = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/top5-department/company`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getMeetingMonthlyTrendForCompany = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/monthly-trend/company`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getPaperlessStatForPersonal = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/paperless/personal`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getMeetingCountAndTotalDurationStatForHosting = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/count-and-totalduration/hosting`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getMeetingCountAndTotalDurationStatForAttendance = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/count-and-totalduration/attendance`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getTop5DepartmentWithMeetingForOffice = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/top5-department/office`, {
		startDate: startDate,
		endDate: endDate,
	});
}
...
const getMeetingMonthlyTrendForPersonal = (data = {}) => {
	...
	return Api.Get(`/api/ewp/meeting/stat/monthly-trend/personal`, {
		startDate: startDate,
		endDate: endDate,
	});
}
