...
public class AdminInfoVO extends UserInfoModelVO {
	...
	public AdminInfoVO(AdminInfoDTO dto) {
		...
		this.domainRole = dto.getDomainRole();
		this.positionRole = dto.getPositionRole();
	}
	

	@Override
	public AdminInfoDTO convert() {
		return AdminInfoDTO.initDTO().vo(this).build();
	}
