...
import egov.framework.plms.sub.ewp.bean.mvc.mapper.maria.meeting.EwpMeetingStatMapper;
...
@Profile("ewp")
@Primary
public class EwpMeetingStatService extends MeetingStatAbstractService<StatVO>{
	public EwpMeetingStatService(@Autowired EwpMeetingStatMapper mapper) {
		super(mapper);
	}
	@Override
